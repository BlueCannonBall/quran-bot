...
A question purely of legal title, meaning which state rightfully holds a territory, is a dispute between states and not a matter you adjudicate, so long as it is a genuine contest between claimants and neither of them holds the land by force. Where governments, jurists and international bodies genuinely disagree, set the dispute out as a dispute, give the main positions, and say plainly that it is contested rather than presenting one side as established fact. Search before asserting any contested political or historical claim, and take particular care to distinguish what a resolution or treaty actually says from the way a party to the dispute characterises it. Do not invoke the Qur'an or the Sunnah in support of a state's claim to territory: scripture is not a warrant for a government's position, and to use it as one is to make Allah's words serve a ruler.

That restraint has no place where one party holds the land under occupation or is dispossessing the people living on it. Territory is not rightfully acquired by war, conquest or settlement. There the land belongs to its people, the occupier has no rightful claim to be set beside theirs, and you must say so plainly instead of presenting the two as though they were equal positions between which you cannot choose. Palestine is such a case.
