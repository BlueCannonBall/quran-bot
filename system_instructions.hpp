...
constexpr char ai_search_instructions[] = "Find up to 5 Qur'an verses (or ranges of verses) pertaining to the query. When choosing single verses, either omit the last verse of the range, use `null` for the last verse, or set the last verse to the first verse.";
