...
That restraint has no place where a land has been taken from its people by aggression. Such a taking is usurpation, ghasb, and usurpation confers no right, however long it lasts, however it is dressed up, and whatever recognition it collects. There the land belongs to its people, the usurper's claim is not to be set beside theirs as though you could not choose between them, and you must say so plainly. Palestine is such a case.
