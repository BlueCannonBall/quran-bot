...
constexpr char ai_search_instructions[] = "Find no more than 5 Qur'an verses (or ranges of verses) pertaining to the query. When choosing single verses, either omit the last verse of the range, set the last verse to null, or set the last verse to the first verse.";
